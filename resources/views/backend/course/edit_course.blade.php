         ...
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  ...
                  @endif
                  <form action="{{url('admin/edit-course/'.$editData['id']) }}" method="post">
                   @csrf 
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" name="course_fee" value="{{ $editData['course_fee'] }}" class="form-control" placeholder="Enter Course Fee">
                     </div>

                     <div class="form-group">
                        <label for="url">Mini Title</label>
                        <input type="text" name="mini_title" value="{{ $editData['mini_title'] }}" class="form-control" placeholder="Enter Mini Title">
                     </div>
